    ...
    <>
      <BrowserRouter>
        <div className="relative grid min-h-[100vh]">
          <nav
            className={`md:bg-transparent ${isNavFull?'md:bg-gray-100 md:top-0':'md:bg-transparent md:top-4'} md:transition-all duration-300 ease-in-out bg-gray-100 md:h-[10vh] h-[8vh] flex items-center fixed w-full top-0 z-[100]`}
          >
